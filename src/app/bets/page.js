...
import { BetCard, BetCardBySport, BetResults } from "../../components/bets";
...
export default function BetsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 items-center min-h-screen">
      <div className="text-2xl font-semibold pt-10">Bets Dashboard</div>
      <div className="grid grid-cols-3 gap-6 w-full bg-gray-50 p-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div>Data by Sport</div>
            {showDropdown && (
              <div className="flex flex-col gap-2 mt-2 max-h-[30vh] overflow-y-scroll">
                {uniqueSports
                  .sort(
                    (a, b) =>
