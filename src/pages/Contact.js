            ...
            <div className="flex justify-center mt-24">
                ...
                <div className="flex justify-start m-10">
                    <div className="bg-[#EFEFEF] px-12 pt-12 w-[44vw] border-2 border-black rounded-tl-3xl rounded-br-3xl hover:shadow-xl duration-300 font-light text-4xl">
                        <div className="group h-20 w-28 overflow-hidden duration-1000 delay-800 ease-in-out hover:w-full relative cursor-pointer flex items-center "
                        ...
                        <div className="group h-20 w-32 overflow-hidden duration-1000 delay-800 ease-in-out hover:w-72 relative cursor-pointer flex items-center "
                        ...
                        <a href={info.github} target="_blank" rel="noreferrer">
                            <h1 className="h-20 flex items-center text-black">
                                GITHUB
                            </h1>
                        </a>
                ...
                <div className="m-10 w-[660px]">
                    <form ref={form} onSubmit={sendEmail} className="w-[26vw] bg-[#DCDCDC] h-full flex flex-col items-center p-8 gap-5 rounded-tl-3xl rounded-br-3xl border-2 border-black hover:shadow-xl duration-300">
                        or you can email me:
