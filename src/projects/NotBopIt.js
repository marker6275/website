...
export function BopIt() {
  ...
  return (
    <div className="py-5">
      ...
      <ST>Hardware</ST>
      <img src="/assets/project_images/NotBopIt/microbit.png" alt="Microbit" className="w-1/6 mx-auto" />
      <P>
      ...
      <div className="grid grid-cols-3 p-10 gap-10">
        <div>
          <img src="/assets/project_images/NotBopIt/task.png" alt="Task" className="mb-2" />
          <C>
            New Task Screen
          </C>
        </div>
        <div>
          <img src="/assets/project_images/NotBopIt/completedtask.png" alt="Completed Task" className="mb-2" />
          <C>
            Repeat Task Screen
          </C>
        </div>
        <div>
          <img src="/assets/project_images/NotBopIt/losingscreen.png" alt="Losing Screen" className="mb-2"  />
          <C>
            Losing Screen
          </C>
        </div>
      ...
      <img src="/assets/project_images/NotBopIt/notbopit.png" alt="Not Bop-It" className="w-1/2 mx-auto pt-5 mb-2" />
      <C>
