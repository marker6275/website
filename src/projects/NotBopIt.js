            ...
            <div className="py-5">
                ...
                <div className="grid grid-cols-3 p-10 gap-10">
                    <div>
                        ...
                        <p className="flex items-center justify-center font-bold text-sm">New Task Screen</p>
                    </div>
                    <div>
                        <img src={completedtask} alt="Completed Task"/>
                        <p className="flex items-center justify-center font-bold text-sm">Repeat Task Screen</p>
                    </div>
                    <div>
                        <img src={losingscreen} alt="Losing Screen"/>
                        <p className="flex items-center justify-center font-bold text-sm">Losing Screen</p>
                    </div>
                </div>
                <div>
                    <i>
                        <p>
                            I am not an text artist.
                        </p>
                        <p>
                            Or maybe I am.
                        </p>
