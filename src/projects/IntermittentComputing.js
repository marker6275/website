...
class Intermittent extends React.Component {
  render() {
    return (
      <div className="py-5">
        <h1 className="text-5xl mb-5 font-semibold">Intermittent Computing</h1>
        <hr className="mb-5" />
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">
          Objectives (from the official website)
        </h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Introduction</h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Constraints</h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Hashcash</h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Approach</h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Code Efficiency</h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">
          Function Modularity and Atomic Design
        </h1>
        <p>
        ...
        <h1 className="font-semibold text-2xl pb-2 pt-5">Results</h1>
        <p>
