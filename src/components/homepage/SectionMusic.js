        ...
        <div className="flex-col align-items py-20 bg-[#F1F1F1]">
            ...
            <div className="flex justify-center">
                <MusicCard
                    ...
                    channel={featuredMusic.channel ? featuredMusic.channel : info[1].youtube}
                />
            </div>
            <div className='px-36 font-bold flex justify-center mt-5'>
                <Link to='/music'>
                    <div>
                        <span className='text-md bg-[#4c5659] text-white p-3 rounded-md hover:bg-[#647175] duration-300'>ALL MUSIC</span>
                    </div>
                </Link>
            </div>
        </div>
